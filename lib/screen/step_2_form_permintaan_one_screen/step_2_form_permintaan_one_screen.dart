...
class Step2FormPermintaanOneScreen extends StatelessWidget {
  const Step2FormPermintaanOneScreen({Key? key}) : super(key: key);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
      ...
      title: Column(
        children: [
          AppbarTitle(text: "Form Pengajuan Permintaan ",
